...
Tier 1 (default): render + static checks. Fast, needs only archetect 2.x + network/cache.
Tier 2 (-m build): compiles and unit-tests the generated project. Needs the dotnet SDK.
"""
